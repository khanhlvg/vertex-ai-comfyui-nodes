...
NODE_CLASS_MAPPINGS = {**IMAGEN_CLASS_MAPPINGS, **GEMINI_CLASS_MAPPINGS, **IMAGEN_EXP_CLASS_MAPPINGS, **VEO_CLASS_MAPPINGS, **LYRIA_CLASS_MAPPINGS, **CHIRP_CLASS_MAPPINGS, **PREVIEW_CLASS_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**IMAGEN_DISPLAY_NAME_MAPPINGS, **GEMINI_DISPLAY_NAME_MAPPINGS, **IMAGEN_EXP_DISPLAY_NAME_MAPPINGS, **VEO_DISPLAY_NAME_MAPPINGS, **LYRIA_DISPLAY_NAME_MAPPINGS, **CHIRP_DISPLAY_NAME_MAPPINGS, **PREVIEW_DISPLAY_NAME_MAPPINGS}
