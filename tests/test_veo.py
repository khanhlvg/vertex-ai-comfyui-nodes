...
from vertex_ai_comfyui_nodes.veo import Veo2Node, Veo3Node, VeoPromptWriterNode, Veo2Extend
...
class TestVeoNode(unittest.TestCase):
    ...
    def test_generate_video_and_verify_with_gemini(self):
        ...
        verification_prompt = f"Is there an eagle in this image? Answer with only 'yes' or 'no'."
    ...
    def test_generate_video_from_image(self):
        ...
        verification_prompt_output = f"Is there a lion in this image? Answer with only 'yes' or 'no'."
